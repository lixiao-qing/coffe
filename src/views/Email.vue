<template>
  <div class="email" style="background-color: #ffff99">
    <van-nav-bar class="animated  fadeInLeft" title="验证码" left-text="返回" left-arrow :fixed="true" @click-left="back" />

    <van-form @submit="next" class="animated  fadeInLeft" >
      <van-field
